...
/// <summary>
/// Everything called by this class is on the server/host only.
/// </summary>
public class SeedNetworkRoomManager : NetworkManager
{
    ...
    public List<SeedNetworkRoomPlayer> roomPlayers;
    ...
    {
        base.Awake();
        roomPlayers = new List<SeedNetworkRoomPlayer>();
    }
    ...
    public override void OnClientConnect(NetworkConnection conn)
    {
        ...
        conn.Send<CreatePlayerMessage>(new CreatePlayerMessage { name = playerName });
    }
